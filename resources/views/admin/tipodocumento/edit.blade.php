...
<div class="conteudo">
    ...
    @endif
    <form class="form-horizontal" method="post" action="{{ route('tipodocumentos.update', $tipodocumento->id) }}">
        <input type="hidden" name="_token" value="{{csrf_token()}}">
        <div class="form1">
            <div class="form-group form-group-sm">
                <label class="control-label col-sm-2" for="nome">Tipo Documento:</label>
              <div class="col-sm-8">
                  <input class="form-control" type="text" name="nome" value="{{ $tipodocumento->nome }}">
              </div>
            </div>
